...
public class Pane extends Block {
   ...
   public Pane(Material materialIn, String name, float hard, float resi, boolean canDrop) {
      super(materialIn);
   ...
   public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
      return state.withProperty(NORTH, this.canPaneConnectTo(worldIn, pos, EnumFacing.NORTH))
         ...
         .withProperty(WEST, this.canPaneConnectTo(worldIn, pos, EnumFacing.WEST))
   ...
   public Pane setSound(SoundType sound) {
