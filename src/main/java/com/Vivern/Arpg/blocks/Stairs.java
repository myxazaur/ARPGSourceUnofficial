...
public class Stairs extends Block {
   ...
   public Stairs(IBlockState modelState, Material mater, String name, float hard, float resi, SoundType stype, String tool, int harvestlvl) {
      super(mater);
   ...
   public static class HardStairs extends Stairs implements IBlockHardBreak {
