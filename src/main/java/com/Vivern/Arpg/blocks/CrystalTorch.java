...
public class CrystalTorch extends Block {
   ...
   public CrystalTorch() {
      ...
      this.setRegistryName("crystal_torch");
      this.setTranslationKey("crystal_torch");
      ...
      if (rand.nextFloat() < 0.23F) {
         ...
         if (enumfacing.getAxis().isHorizontal()) {
            ...
            GUNParticle spelll = new GUNParticle(
               ...
               240,
               worldIn,
               d0 + 0.27 * enumfacing1.getXOffset() + randispl1,
               d1 + 0.22 + randispl2,
               d2 + 0.27 * enumfacing1.getZOffset() + randispl3,
               randsp1,
               randsp2,
               randsp3,
               1.0F,
