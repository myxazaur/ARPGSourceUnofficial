...
public class ArthrostelechaLeaves extends Block implements IShearable {
   public static final PropertyBool DECAYABLE = PropertyBool.create("decayable");
   public static final PropertyBool CHECK_DECAY = PropertyBool.create("check_decay");
   int[] surroundings;

   public ArthrostelechaLeaves(boolean brass) {
      super(Material.LEAVES);
      this.setRegistryName(brass ? "arthrostelecha_leaves_brass" : "arthrostelecha_leaves_pink");
      this.setTranslationKey(brass ? "arthrostelecha_leaves_brass" : "arthrostelecha_leaves_pink");
         ...
         for (int j1 = -1; j1 <= 1; j1++) {
            for (int k1 = -1; k1 <= 1; k1++) {
               for (int l1 = -1; l1 <= 1; l1++) {
                  ...
                  if (ArthrostelechaLog.isArthrostelechaLeaves(iblockstate.getBlock())) {
            ...
            for (int i2 = -4; i2 <= 4; i2++) {
               for (int j2 = -4; j2 <= 4; j2++) {
                  for (int k2 = -4; k2 <= 4; k2++) {
                     ...
                     if (!ArthrostelechaLog.isArthrostelechaLog(block)) {
                        if (ArthrostelechaLog.isArthrostelechaLeaves(block)) {
