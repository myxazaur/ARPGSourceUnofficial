...
public class EthernalFrostPortal extends Block {
   public EthernalFrostPortal() {
      super(Material.PORTAL);
      this.setRegistryName("ethernal_frost_portal");
      this.setTranslationKey("ethernal_frost_portal");
   ...
   public void onEntityCollision(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
      if (entityIn != null
         ...
         DimensionsRegister.teleporterEVERFROST.teleport((EntityPlayer)entityIn, pos);
      }
   }

   public Class<TileEntityFrostPortal> getTileEntityClass() {
      return TileEntityFrostPortal.class;
   }

   public TileEntityFrostPortal getTileEntity(IBlockAccess world, BlockPos position) {
