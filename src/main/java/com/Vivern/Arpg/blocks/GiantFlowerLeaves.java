...
public class GiantFlowerLeaves extends Block implements IShearable {
   public static final PropertyBool DECAYABLE = PropertyBool.create("decayable");
   public static final PropertyBool CHECK_DECAY = PropertyBool.create("check_decay");
   int[] surroundings;

   public GiantFlowerLeaves() {
      super(Material.LEAVES);
      this.setRegistryName("giant_flower_leaves");
      this.setTranslationKey("giant_flower_leaves");
