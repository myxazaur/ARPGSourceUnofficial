...
public class PacketWeaponEffectToClients extends Packet {
   double x = 0.0;
   double y = 0.0;
   double z = 0.0;
   double a = 0.0;
   ...
   public void writeargs(double x, double y, double z, double a, double b, double c, double d1, double d2, double d3, int id) {
   ...
   void processMessage(Item item) {
      try {
         ((IWeapon)item)
            .effect(this.clientPlayer(), this.clientPlayer().world, this.x, this.y, this.z, this.a, this.b, this.c, this.d1, this.d2, this.d3);
