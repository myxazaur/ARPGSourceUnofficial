...
public class WizardLeggins extends ItemArmor {
   ...
   public WizardLeggins() {
      super(WizardHelm.wizard_mt, 0, EntityEquipmentSlot.LEGS);
      this.setRegistryName("wizard_leggins");
      this.setTranslationKey("wizard_leggins");
