...
public class FireMageBoots extends ItemArmor {
   ...
   public FireMageBoots() {
      super(FireMageHelm.firemage_mt, 0, EntityEquipmentSlot.FEET);
      this.setRegistryName("firemage_boots");
      this.setTranslationKey("firemage_boots");
