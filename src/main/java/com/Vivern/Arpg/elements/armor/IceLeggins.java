...
public class IceLeggins extends ItemArmor {
   ...
   public IceLeggins() {
      super(IceHelm.ice_mt, 0, EntityEquipmentSlot.LEGS);
      this.setRegistryName("ice_armor_leggins");
      this.setTranslationKey("ice_armor_leggins");
   ...
   public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
      return "arpg:textures/ice_armor_2.png";
   }
}
