...
public class SlimeChestplate extends ItemArmor {
   ...
   public SlimeChestplate() {
      super(SlimeHelm.slime_mt, 0, EntityEquipmentSlot.CHEST);
      this.setRegistryName("slime_chestplate");
      this.setTranslationKey("slime_chestplate");
   ...
   public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
      ...
      if (equipmentSlot == this.armorType) {
         ...
         multimap.put(
            PropertiesRegistry.JUMP_HEIGHT.getName(), new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor jumping", 0.03, 0)
         );
         multimap.put(
