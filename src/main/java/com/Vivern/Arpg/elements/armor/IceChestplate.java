...
public class IceChestplate extends ItemArmor {
   ...
   public IceChestplate() {
      super(IceHelm.ice_mt, 0, EntityEquipmentSlot.CHEST);
      this.setRegistryName("ice_armor_chestplate");
      this.setTranslationKey("ice_armor_chestplate");
