...
public class FireLordBoots extends ItemArmor {
   ...
   public FireLordBoots() {
      super(FireLordHelm.firelord_mt, 0, EntityEquipmentSlot.FEET);
      this.setRegistryName("firelord_boots");
      this.setTranslationKey("firelord_boots");
   ...
   public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
      ...
      if (equipmentSlot == this.armorType) {
         ...
         multimap.put(
            ...
            new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor protection", 0.8, 0)
         );
         multimap.put(
