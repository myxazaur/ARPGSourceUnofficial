...
public class SieveModel extends ModelBase {
   ...
   public SieveModel() {
      ...
      this.slegs = new ModelRenderer(this, 0, 8);
      this.slegs.setRotationPoint(0.0F, 20.0F, 0.0F);
      this.slegs.addBox(-7.0F, 0.0F, -7.0F, 14, 4, 14, 0.0F);
      this.sieve = new ModelRenderer(this, 0, 46);
      ...
      this.leg2.addBox(4.0F, 0.0F, -7.0F, 3, 3, 14, 0.01F);
      ...
      this.leg1.addBox(-7.0F, 0.0F, -7.0F, 3, 3, 14, 0.01F);
