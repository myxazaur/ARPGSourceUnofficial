...
public class EchinusModel extends ModelBase {
   ...
   public EchinusModel() {
      ...
      this.mace3.addBox(-5.0F, -5.0F, 0.0F, 10, 10, 0, 0.0F);
      this.setRotateAngle(this.mace3, 0.0F, (float) (Math.PI / 3), 0.0F);
      this.staf1 = new ModelRenderer(this, 0, 23);
      this.staf1.setRotationPoint(0.0F, 4.0F, 5.0F);
      this.staf1.addBox(-2.0F, -5.0F, -2.0F, 4, 5, 4, 0.0F);
      this.setRotateAngle(this.staf1, -0.045553092F, 0.0F, 0.0F);
      ...
      this.chainA_3 = new ModelRenderer(this, 28, 10);
      ...
      this.mace2 = new ModelRenderer(this, 8, 0);
      this.mace2.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.mace2.addBox(0.0F, -5.0F, -5.0F, 0, 10, 10, 0.0F);
      this.setRotateAngle(this.mace2, 0.0F, (float) (Math.PI / 2), 0.0F);
      ...
      this.smace1.setRotationPoint(0.0F, -6.5F, 0.0F);
      this.smace1.addBox(-2.5F, -2.5F, -2.5F, 5, 5, 5, 0.0F);
      this.setRotateAngle(this.smace1, 0.0F, -0.3642502F, 0.0F);
      ...
      this.smace2 = new ModelRenderer(this, 8, 0);
      this.smace2.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.smace2.addBox(0.0F, -5.0F, -5.0F, 0, 10, 10, 0.0F);
      this.setRotateAngle(this.smace2, 0.0F, (float) (Math.PI / 2), 0.0F);
      ...
      this.mace4 = new ModelRenderer(this, 8, 10);
      this.mace4.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.mace4.addBox(-5.0F, -5.0F, 0.0F, 10, 10, 0, 0.0F);
      this.setRotateAngle(this.mace4, 0.0F, (float) (-Math.PI / 3), 0.0F);
      ...
      this.smace4 = new ModelRenderer(this, 8, 10);
      this.smace4.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.smace4.addBox(-5.0F, -5.0F, 0.0F, 10, 10, 0, 0.0F);
      this.setRotateAngle(this.smace4, 0.0F, (float) (-Math.PI / 3), 0.0F);
      ...
      this.smace3.addBox(-5.0F, -5.0F, 0.0F, 10, 10, 0, 0.0F);
      this.setRotateAngle(this.smace3, 0.0F, (float) (Math.PI / 3), 0.0F);
      ...
      this.staf2 = new ModelRenderer(this, 16, 23);
      this.staf2.setRotationPoint(0.0F, 17.0F, 5.0F);
      this.staf2.addBox(-2.0F, 0.0F, -2.0F, 4, 5, 4, 0.0F);
   ...
   public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
      if (f == -2.0F) {
         ...
         GlStateManager.translate(this.mace1.offsetX, this.mace1.offsetY, this.mace1.offsetZ);
         GlStateManager.translate(this.mace1.rotationPointX * f5, this.mace1.rotationPointY * f5, this.mace1.rotationPointZ * f5);
