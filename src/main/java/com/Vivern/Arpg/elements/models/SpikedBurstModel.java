...
public class SpikedBurstModel extends ModelBase {
   public ModelRenderer shape1;
   public ModelRenderer shape2;

   public SpikedBurstModel() {
      this.textureWidth = 16;
      this.textureHeight = 16;
      this.shape1 = new ModelRenderer(this, 0, 0);
      this.shape1.setRotationPoint(0.0F, -1.0F, 0.0F);
      this.shape1.addBox(-1.0F, -0.5F, 0.0F, 2, 1, 5, 0.0F);
      this.shape2 = new ModelRenderer(this, 0, 6);
      this.shape2.setRotationPoint(0.0F, -1.0F, 0.0F);
      this.shape2.addBox(-0.5F, -0.5F, -5.0F, 1, 1, 5, 0.0F);
   }
