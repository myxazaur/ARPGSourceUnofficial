...
public class ContainerAlchemicVaporizer extends Container {
   private final IInventory tileInventory;

   public ContainerAlchemicVaporizer(InventoryPlayer playerInventory, IInventory iInventory) {
      this.tileInventory = iInventory;
      this.addSlotToContainer(new Slot(iInventory, 0, 89, 30));
