...
public class ContainerPyrocrystalline extends Container {
   private final IInventory tileInventory;

   public ContainerPyrocrystalline(InventoryPlayer playerInventory, IInventory iInventory) {
      this.tileInventory = iInventory;
      this.addSlotToContainer(new Slot(iInventory, 0, 62, 18));
      this.addSlotToContainer(new Slot(iInventory, 1, 80, 18));
      this.addSlotToContainer(new Slot(iInventory, 2, 98, 18));
      this.addSlotToContainer(new Slot(iInventory, 3, 44, 78));
