...
public class ContainerElementDistributor extends Container {
   private final IInventory tileInventory;

   public ContainerElementDistributor(InventoryPlayer playerInventory, IInventory tileInventory) {
      this.tileInventory = tileInventory;
      this.addSlotToContainer(new Slot(tileInventory, 0, 8, 27));
