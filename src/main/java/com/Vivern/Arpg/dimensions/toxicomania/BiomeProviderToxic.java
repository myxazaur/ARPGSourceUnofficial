...
public class BiomeProviderToxic extends BiomeProvider {
   private GenLayer genBiomes;
   private GenLayer biomeIndexLayer;
   private BiomeCache biomeCache = new BiomeCache(this);

   public BiomeProviderToxic() {
   }

   public BiomeProviderToxic(long seed) {
      this();
      GenLayer[] agenlayer = GenLayerFixToxic.initializeAllBiomeGenerators(seed);
      this.genBiomes = agenlayer[0];
      this.biomeIndexLayer = agenlayer[1];
   }

   public BiomeProviderToxic(World world) {
      this(world.getSeed());
   }
