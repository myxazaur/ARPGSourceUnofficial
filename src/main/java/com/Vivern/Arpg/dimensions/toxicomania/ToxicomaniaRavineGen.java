...
public class ToxicomaniaRavineGen extends MapGenBase {
   ...
   protected void addTunnel(
      ...
      for (; p_180707_15_ < p_180707_16_; p_180707_15_++) {
         double d9 = 1.5 + MathHelper.sin(p_180707_15_ * (float) Math.PI / p_180707_16_) * p_180707_12_;
                     ...
                     for (int i2 = i3; i2 < i1; i2++) {
                        ...
                        if (d10 * d10 + d7 * d7 < 1.0) {
                           for (int j2 = l; j2 > l2; j2--) {
                              ...
                              if ((d10 * d10 + d7 * d7) * this.rs[j2 - 1] + d8 * d8 / 6.0 < 1.0) {
   ...
   protected void recursiveGenerate(World worldIn, int chunkX, int chunkZ, int originalX, int originalZ, ChunkPrimer chunkPrimerIn) {
      if (this.rand.nextInt(50) == 0) {
         ...
         for (int j = 0; j < 1; j++) {
            ...
            this.addTunnel(this.rand.nextLong(), originalX, originalZ, chunkPrimerIn, d0, d1, d2, f2, f, f1, 0, 200, 3.0);
         }
      }
   }
