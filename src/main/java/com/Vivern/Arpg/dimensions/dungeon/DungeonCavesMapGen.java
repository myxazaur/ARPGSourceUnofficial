...
public class DungeonCavesMapGen extends MapGenBase {
   ...
   protected void addTunnel(
      ...
      for (boolean flag = random.nextInt(8) == 0; p_180702_15_ < p_180702_16_; p_180702_15_++) {
         double d2 = 2.5 + MathHelper.sin(p_180702_15_ * (float) Math.PI / p_180702_16_) * p_180702_12_;
   ...
   protected void recursiveGenerate(World worldIn, int chunkX, int chunkZ, int originalX, int originalZ, ChunkPrimer chunkPrimerIn) {
      ...
      for (int j = 0; j < i; j++) {
         ...
         for (int l = 0; l < k; l++) {
            ...
            float f2 = this.rand.nextFloat() * 5.0F + this.rand.nextFloat();
            if (this.rand.nextInt(8) == 0) {
               f2 *= this.rand.nextFloat() * this.rand.nextFloat() * 3.0F + 1.0F;
            }

            this.addTunnel(this.rand.nextLong(), originalX, originalZ, chunkPrimerIn, d0, d1, d2, f2, f, f1, 0, 100, 1.0);
         }
      }
   }
