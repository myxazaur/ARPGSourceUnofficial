...
public class DungeonChunkGenSettings {
   ...
   private DungeonChunkGenSettings(Factory settingsFactory) {
   ...
   public static class Factory {
      ...
      public DungeonChunkGenSettings build() {
         return new DungeonChunkGenSettings(this);
      }
   }
