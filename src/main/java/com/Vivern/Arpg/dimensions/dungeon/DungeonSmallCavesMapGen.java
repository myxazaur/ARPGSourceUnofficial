...
public class DungeonSmallCavesMapGen extends MapGenBase {
   ...
   protected void addTunnel(
      ...
      for (boolean flag = random.nextInt(8) == 0; p_180702_15_ < p_180702_16_; p_180702_15_++) {
         double d2 = 1.2 + MathHelper.sin(p_180702_15_ * (float) Math.PI / p_180702_16_) * p_180702_12_;
   ...
   protected void recursiveGenerate(World worldIn, int chunkX, int chunkZ, int originalX, int originalZ, ChunkPrimer chunkPrimerIn) {
      ...
      for (int j = 0; j < i; j++) {
         ...
         for (int l = 0; l < k; l++) {
            ...
            this.addTunnel(this.rand.nextLong(), originalX, originalZ, chunkPrimerIn, d0, d1, d2, f2, f, f1, 0, 100, 0.4);
         }
      }
   }
