...
public class ChunkGenSettingsAqua {
   ...
   private ChunkGenSettingsAqua(Factory settingsFactory) {
   ...
   public static class Factory {
      ...
      public void setDefaults() {
         ...
         this.mainNoiseScaleX = 680.0F;
         this.mainNoiseScaleY = 660.0F;
         this.mainNoiseScaleZ = 680.0F;
         this.baseSize = 8.5F;
         this.stretchY = 12.0F;
         this.biomeDepthWeight = 1.0F;
         this.biomeDepthOffset = 2.0F;
      ...
      public void setDefaults2() {
         this.coordinateScale = 284.412F;
         this.heightScale = 544.412F;
         this.upperLimitScale = 312.0F;
         this.lowerLimitScale = 612.0F;
         this.depthNoiseScaleX = 200.0F;
         this.depthNoiseScaleZ = 200.0F;
         this.depthNoiseScaleExponent = 0.5F;
         this.mainNoiseScaleX = 740.0F;
         this.mainNoiseScaleY = 860.0F;
         this.mainNoiseScaleZ = 740.0F;
         this.baseSize = 4.0F;
         this.stretchY = 14.0F;
         this.biomeDepthWeight = 1.3F;
         this.biomeDepthOffset = 1.0F;
         this.biomeScaleWeight = 0.8F;
         this.biomeScaleOffset = 0.9F;
         this.seaLevel = 32;
         this.useCaves = true;
         this.useDungeons = true;
         this.dungeonChance = 8;
      ...
      public boolean equals(Object p_equals_1_) {
         if (this == p_equals_1_) {
            ...
            Factory chunkGenSettings$factory = (Factory)p_equals_1_;
      ...
      public ChunkGenSettingsAqua build() {
         return new ChunkGenSettingsAqua(this);
      }
   }
   ...
   public static class Serializer implements JsonDeserializer<Factory>, JsonSerializer<Factory> {
      public Factory deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
         ...
         try {
            ...
            chunkGenSettings$factory.depthNoiseScaleExponent = JsonUtils.getFloat(
               jsonobject, "depthNoiseScaleExponent", chunkGenSettings$factory.depthNoiseScaleExponent
            );
