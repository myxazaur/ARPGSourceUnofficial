...
public class EntityAIAgree<T extends EntityLivingBase> extends EntityAITarget {
   protected final Class<T> targetClass;
   private final int targetChance;
   protected final net.minecraft.entity.ai.EntityAINearestAttackableTarget.Sorter sorter;
   protected final Predicate<? super T> targetEntitySelector;
   protected T targetEntity;
   public AbstractMob mob;
   public double verticalZone;

   public EntityAIAgree(AbstractMob creature, Class<T> classTarget, boolean checkSight) {
      this(creature, classTarget, checkSight, false, 0.25);
   }

   public EntityAIAgree(AbstractMob creature, Class<T> classTarget, boolean checkSight, double verticalZone) {
      this(creature, classTarget, checkSight, false, verticalZone);
   }
      ...
      if (this.targetChance > 0 && this.taskOwner.getRNG().nextInt(this.targetChance) != 0) {
         ...
         this.targetEntity = (T)this.taskOwner
            ...
            .getNearestAttackablePlayer(
               ...
               this.getTargetDistance(),
               null,
                    // FIX: cast `targetEntitySelector` to `Predicate<EntityPlayer>`
