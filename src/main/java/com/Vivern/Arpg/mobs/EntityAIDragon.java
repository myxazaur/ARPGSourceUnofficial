...
public class EntityAIDragon extends AbstractMob.AbstractAI {
   ...
   public EntityAIDragon setBurst(boolean burst, int burstMaxCount, int maxnormalShootsToBurst, boolean canStop, int maxCooldownOnBurst) {
      this.burst = burst;
   ...
   public void updateTask() {
      ...
      if (this.MODE == 0) {
         if (this.onGround(this.entity.world, this.entity.posX, this.entity.posY, this.entity.posZ) && this.canWalk) {
            if (this.canWalk) {
      ...
      if (entitylivingbase != null) {
         ...
         if (this.MODE != 1) {
            ...
            if (this.entity.posY > entitylivingbase.posY + 1.0) {
               if (this.strafeVec == null) {
                  double vX = entitylivingbase.posX - this.entity.posX;
                  double vZ = entitylivingbase.posZ - this.entity.posZ;
                  this.strafeVec = new Vec3d(vX, 0.0, vZ).normalize();
                  this.entity.world.setEntityState(this.entity, (byte)(4 + this.sendEntStateAdd));
               }
            } else {
               this.strafeVec = null;
               this.rushTIME = 0;
               this.MODE = this.rand.nextFloat() < 0.5 ? 2 : 3;
               this.entity.world.setEntityState(this.entity, (byte)(this.MODE + this.sendEntStateAdd));
               this.entity.var1 = this.MODE;
            }

            if (this.strafeVec != null) {
               this.entity.motionX = this.entity.motionX + this.strafeVec.x * speed / 5.0;
               this.entity.motionZ = this.entity.motionZ + this.strafeVec.z * speed / 5.0;
               this.rushTIME++;
               this.entity
                  .getLookHelper()
                  .setLookPosition(
                     this.entity.posX + this.strafeVec.x,
                     this.entity.posY - 8.0,
                     this.entity.posZ + this.strafeVec.z,
                     30.0F,
                     30.0F
                  );
               if (this.rushTIME == 5) {
               ...
               if (this.rushTIME > 50 || this.entity.getDistanceSq(entitylivingbase) > 256.0) {
                  this.strafeVec = null;
                  this.rushTIME = 0;
                  this.MODE = this.rand.nextFloat() < 0.5 ? 2 : 3;
                  this.entity.world.setEntityState(this.entity, (byte)(this.MODE + this.sendEntStateAdd));
         ...
         if (this.MODE == 2) {
            ...
            if (this.entity.ticksExisted % 5 == 0 && this.flyingAxisVector != null) {
               ...
               for (int axi = 0; axi < 6; axi++) {
                  ...
                  if (this.entity.noClip || this.tryMove(moveX, moveY, moveZ)) {
               ...
               if (this.TURNMODECHANCE >= 1.0F && !cansee) {
                  this.firstAgred = true;
               }
            }
