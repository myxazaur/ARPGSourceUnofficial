...
public class RenderToxicSky extends IRenderHandler {
   public static ResourceLocation MOON_PHASES_TEXTURES = new ResourceLocation("arpg:textures/moon_phases_toxic.png");
   public static ResourceLocation SUN_TEXTURES = new ResourceLocation("arpg:textures/sun_toxic.png");
   ...
   public RenderToxicSky(TimeOfDayProvider timeOfDayProvider) {
   ...
   public void renderSpace(BufferBuilder bufferBuilderIn) {
      GlStateManager.enableTexture2D();
      Random random = new Random(434324L);
