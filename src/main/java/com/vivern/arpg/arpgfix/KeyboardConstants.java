...
public class KeyboardConstants {
    ...
    /**
     * Copy-paste from client-side class to prevent ClassNotFound exception on the server.
...
//    public static final int KEY_COUNT = Keyboard.KEYBOARD_SIZE; // 256
    public static final int KEY_COUNT = 256; // 256
}