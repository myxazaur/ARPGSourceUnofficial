...
public class BiomeProviderStormledge extends BiomeProvider {
   private GenLayer genBiomes;
   private GenLayer biomeIndexLayer;
   private BiomeCache biomeCache = new BiomeCache(this);

   public BiomeProviderStormledge() {
   }

   public BiomeProviderStormledge(long seed) {
      this();
      GenLayer[] agenlayer = GenLayerFixStormledge.createWorld(seed);
      this.genBiomes = agenlayer[0];
      this.biomeIndexLayer = agenlayer[1];
   }

   public BiomeProviderStormledge(World world) {
      this(world.getSeed());
   }
