...
public class ChunkGenSettingsToxic {
   ...
   private ChunkGenSettingsToxic(Factory settingsFactory) {
   ...
   public static class Factory {
      ...
      public ChunkGenSettingsToxic build() {
         return new ChunkGenSettingsToxic(this);
      }
   }
