...
public class GlowingCaveCrystal extends Block {
   ...
   public GlowingCaveCrystal() {
      super(Material.GLASS);
      this.setRegistryName("glowing_cave_crystal");
      this.setTranslationKey("glowing_cave_crystal");
      this.blockHardness = 6.2F;
      this.blockResistance = 0.3F;
      this.setSoundType(SoundTypeShards.SHARDS);
      this.setCreativeTab(CreativeTabs.DECORATIONS);
      this.setLightLevel(0.54F);
   }
