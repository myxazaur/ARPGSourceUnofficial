...
public class LoppyToxistem extends Block implements IShearable {
   protected static final AxisAlignedBB AABB = new AxisAlignedBB(0.4, 0.0, 0.4, 0.6, 1.0, 0.6);

   public LoppyToxistem() {
      super(Material.PLANTS);
      this.setRegistryName("loppy_toxistem");
      this.setTranslationKey("loppy_toxistem");
