...
public class ARPGHooks {
   private static List<BlockPos> listMarkRelightPoses = new ArrayList<>();
   private static BlockColors blockColors = new BlockColors();
   private static float blockcolorIntensity = 0.75F;
   ...
   @SideOnly(Side.CLIENT)
   @Hook
   public static ReturnSolve<Void> getNotificationScreen(RealmsBridge bridge, GuiScreen p_getNotificationScreen_1_) {
      return ReturnSolve.no();
   }
   ...
   public static ReturnSolve<ItemTransformVec3f> getTransform(ItemCameraTransforms transforms, TransformType type) {
      ...
      return new ReturnSolve.Yes<>(tr);
   }

   @Hook
   public static ReturnSolve<Void> track(EntityTracker tracker, Entity entityIn, int trackingRange, int updateFrequency, boolean sendVelocityUpdates) {
