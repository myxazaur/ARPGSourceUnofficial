...
public class FrozenWings extends AbstractWings implements IAttributedBauble, IRenderBauble {
   public static FrozenWingsModel model = new FrozenWingsModel();
   public static ResourceLocation texture = new ResourceLocation("arpg:textures/frozen_wings_model_tex.png");

   public FrozenWings() {
      this.setRegistryName("frozen_wings");
      this.setCreativeTab(CreativeTabs.COMBAT);
      this.setTranslationKey("frozen_wings");
   ...
   public Multimap<String, AttributeModifier> getAttributeModifiers(EntityPlayer player, int equipmentSlot, ItemStack itemstack) {
      ...
      multimap.put(PropertiesRegistry.AIRBORNE_MOBILITY.getName(), new AttributeModifier(uuid, "airborn mobility modifier", 0.03 + Debugger.floats[4], 0));
      return multimap;
   }
