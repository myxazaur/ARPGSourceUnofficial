...
public class WizardBoots extends ItemArmor {
   ...
   public WizardBoots() {
      super(WizardHelm.wizard_mt, 0, EntityEquipmentSlot.FEET);
      this.setRegistryName("wizard_boots");
      this.setTranslationKey("wizard_boots");
