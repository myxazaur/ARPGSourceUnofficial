...
public class JungleChestplate extends ItemArmor {
   ...
   public JungleChestplate() {
      super(JungleHelm.jungle_mt, 0, EntityEquipmentSlot.CHEST);
      this.setRegistryName("jungle_chestplate");
      this.setTranslationKey("jungle_chestplate");
   ...
   public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
      ...
      if (equipmentSlot == this.armorType) {
         ...
         multimap.put(
            PropertiesRegistry.LEADERSHIP.getName(), new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor souls", 5.0, 0)
         );
