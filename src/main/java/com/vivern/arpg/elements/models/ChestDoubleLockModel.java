...
public class ChestDoubleLockModel extends ModelChest {
   public ModelRenderer chestKnob_1;

   public ChestDoubleLockModel() {
      ...
      this.chestKnob.addBox(-4.0F, -3.0F, -15.0F, 2, 4, 1, 0.0F);
      this.chestKnob_1 = new ModelRenderer(this, 0, 0);
      this.chestKnob_1.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.chestKnob_1.addBox(2.0F, -3.0F, -15.0F, 2, 4, 1, 0.0F);
      this.chestKnob.addChild(this.chestKnob_1);
   }
