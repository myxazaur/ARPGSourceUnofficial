...
public class AdamantiumKnife extends ItemWeapon {
   public AdamantiumKnife() {
      this.setRegistryName("adamantium_knife");
      this.setCreativeTab(CreativeTabs.COMBAT);
      this.setTranslationKey("adamantium_knife");
   ...
   public void onUpdate(ItemStack itemstack, World world, Entity entityIn, int itemSlot, boolean isSelected) {
      if (!world.isRemote) {
         ...
         if (IWeapon.canShoot(itemstack)) {
            ...
            if (hand != null) {
               if (IWeapon.doMeleeDaggerAttack(this, itemstack, player, hand, false).success) {
                  world.playSound(
                     (EntityPlayer)null,
                     player.posX,
                     player.posY,
